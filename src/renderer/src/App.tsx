      ...
      <main className="workspace">
        {view === 'settings' ? (
          ...
          <>
            ...
            <section
              className={`recorder state-${recorder.state}`}
              ...
              <div className="recorder-copy">
                {analysis.state === 'ready' && analysis.result ? (
                  ...
                  <>
                    ...
                    <p>
                      Your recording is stored locally. Continue to clarify the intended outcome.
                    </p>
                  ...
                  <>
                    ...
                    <p>
                      TaskTape is capturing the selected screen. Stop when the outcome is complete.
                    </p>
                    <button
